...
const ForgotPassword = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center p-4 overflow-hidden">
      {/* Dynamic Background matching Login/Signup */}
      <div 
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-slate-400 text-sm mt-1 uppercase tracking-widest font-semibold">Account Recovery</p>
        </div>
        ...
        <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-2xl border border-white/20">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <Label className="text-xs font-bold uppercase text-slate-500 tracking-wider">Registered Email</Label>
              <div className="relative group">
                <Input
                  type="email"
                  placeholder="name@company.com"
                  className="pl-10 h-12 bg-slate-50 border-slate-200 rounded-xl focus:ring-blue-500 focus:border-blue-500 transition-all disabled:opacity-50"
                  value={email}
